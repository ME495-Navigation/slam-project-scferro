...
namespace turtlelib
{
    ...
    {
    private:
        /// \brief translation vector in 2D
        Vector2D trans;
        /// \brief rotation angle, radians
        double rot;
    public:
    ...
    /// \brief integrate a twist over 1 second
    /// \param twist - the twist
    /// \return the integral of the twist over 1 time unit/second
